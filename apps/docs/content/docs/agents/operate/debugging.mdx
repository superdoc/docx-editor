...
| Output file identical to input                 | The model decided the work was done, or every action resolved to a no-op      | Count mutations by comparing revisions, and refuse to save when there are none       |
