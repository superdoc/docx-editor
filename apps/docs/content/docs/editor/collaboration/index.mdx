...
A **provider** carries changes between the connected editors. You can run a collaboration server yourself or use a hosted service. The next guide starts with a local Hocuspocus server. To keep an existing provider setup, see [Use your own provider](/editor/collaboration/use-your-own-provider).
