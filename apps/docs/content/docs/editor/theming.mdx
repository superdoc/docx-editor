...
Themes style SuperDoc's own interface. They do not affect the fonts stored in the DOCX. Continue with
[Fonts](/editor/fonts) to see how each document font resolves and to provide licensed files for families the browser
cannot render.
